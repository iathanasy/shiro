...
import com.cd.shiro.modules.sys.dao.SysRoleMenuDao;
import com.cd.shiro.modules.sys.entity.SysRoleMenuEntity;
...
public class SysRoleMenuServiceImpl extends ServiceImpl<SysRoleMenuDao, SysRoleMenuEntity> implements SysRoleMenuService {
	...
	public List<Long> queryMenuIdButtonList(Long roleId) {
		return baseMapper.queryMenuIdButtonList(roleId);
	}
